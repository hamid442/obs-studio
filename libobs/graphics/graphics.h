...
EXPORT gs_eparam_t *gs_param_get_annotation_by_name(const gs_eparam_t *param,
		const char *name);
EXPORT gs_eparam_t *gs_technique_get_annotation_by_idx(
	const gs_technique_t *technique, size_t annotation);
EXPORT gs_eparam_t *gs_technique_get_annotation_by_name(
	const gs_technique_t *technique, const char *name);
EXPORT gs_eparam_t *gs_pass_get_annotation_by_idx(const gs_epass_t *pass,
		size_t annotation);
EXPORT gs_eparam_t *gs_pass_get_annotation_by_name(const gs_epass_t *pass,
		const char *name);
